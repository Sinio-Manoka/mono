...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/* Wrap children in <Command> so cmdk's store/context is provided.
            Without this wrapper, CommandPrimitive.Input tries to subscribe
            to an undefined store and throws at render time. */}
